...
import { alertModifyApi, verifyEmailApi } from '@/apis/email.js'
...
const gscanCheck = ref(props.selectedEmail.suspicious)
const dlpCheck = ref(props.selectedEmail.sensitive)
const vtCheck = ref(props.selectedEmail.vt)
...
const emailMake = () => {
  ...
  alertModifyApi(props.selectedEmail.id, data).then((response) => {
